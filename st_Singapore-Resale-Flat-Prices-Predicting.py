...
data = pd.read_csv(r"E:\singapore\mrt.csv")
    ...
    try:
        with st.form("form1"):
            ...
            if submit_button is not None:
                with open(r"E:\singapore\model (1).pkl", 'rb') as file:
                    loaded_model = pickle.load(file)
                with open(r"E:\singapore\scaler.pkl", 'rb') as f:
                ...
                data = pd.read_csv(r"E:\singapore\df_coordinates.csv")
